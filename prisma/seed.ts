...
type AnimalSeed = {
  ...
  isExtinct?: boolean;
  imageUrl?: string;
  // 現実の平均寿命（年）。ゲーム内ではこの日数分だけ生存する。伝説の生き物は 999（不老不死）。
...
const ANIMALS: AnimalSeed[] = [
  ...
  { animalId: "rabbit_japanese", genericName: "うさぎ", specificName: "ニホンノウサギ", name: "ニホンノウサギ",
    ...
    description: "にほんの やまや もりに すむ ウサギ。ふゆに なると けが まっしろに へんしんして、ゆきげしきに とけこむよ！じそく 50キロで かけぬける しょくぶつ だいすきな スピードスター！" , lifespanYears: 7},
  { animalId: "rabbit_european", genericName: "うさぎ", specificName: "アナウサギ", name: "アナウサギ",
    ...
    description: "ヨーロッパ うまれ。じめんに ふくざつな トンネルを ほって、なかまと いっしょに くらすよ。ペットの ウサギは みんな この こが ごせんぞ。めが よこむきで ほぼ ぐるりと みえる！" , lifespanYears: 9},
  { animalId: "rabbit_snow", genericName: "うさぎ", specificName: "ユキウサギ", name: "ユキウサギ",
    ...
    description: "さむい くにに すむ ウサギ。ふゆは けが まっしろ、なつは ちゃいろに かわる へんしん めいじん！ながい あしで ゆきの うえも ぴょんぴょん。きおんに あわせて かわるよ！" , lifespanYears: 3},
  ...
  { animalId: "squirrel_japanese", genericName: "りす", specificName: "ニホンリス", name: "ニホンリス",
    ...
    description: "にほんに しか いない ちいさな リス。あきに ドングリを つちに うめて、ふゆに ほりだして たべるよ。でも わすれちゃう ことも！そこから あたらしい もりが そだつ ふしぎ。" , lifespanYears: 4},
  { animalId: "squirrel_flying", genericName: "りす", specificName: "モモンガ", name: "モモンガ",
    emoji: "🐿️", rarity: "RARE", stageId: "forest", habitat: "アジアの しんりん",
    description: "まえあしと うしろあしの あいだに マントみたいな『ひまく』が あるよ！それを ひろげて きから きへ さいだい 100m も グライダーみたいに とぶ ふしぎな リス！" , lifespanYears: 6},
  { animalId: "squirrel_red", genericName: "りす", specificName: "キタリス", name: "キタリス",
    ...
    description: "ヨーロッパや ロシアの もりに すむ あかちゃいろの リス。みみの さきに ふさふさの けが ぴょんと はえてる！とびうつる ジャンプの きょりは 4m。きの うえの にんじゃ！" , lifespanYears: 6},
  ...
  { animalId: "deer_japanese", genericName: "しか", specificName: "ニホンジカ", name: "ニホンジカ",
    ...
    description: "にほん ぜんこくに すむ シカ。オスだけが まいとし はえかわる りっぱな ツノを もつよ。あきに『バン！』と でっかい こえで メスを よぶ。ならこうえんの シカが ゆうめい！" , lifespanYears: 15},
  { animalId: "deer_sika_white", genericName: "しか", specificName: "ヤクシカ", name: "ヤクシカ",
    emoji: "🦌", rarity: "RARE", stageId: "forest", habitat: "やくしまの しんりん",
    description: "やくしまに しかいない ちいさな シカ。せかいいさんの もりで くらすよ。たいじゅう 30キロほどで ニホンジカの だいたい はんぶんの サイズ。せかいてきにも きちょうな しか！" , lifespanYears: 15},
  ...
  { animalId: "raccoon_dog", genericName: "たぬき", specificName: "ホンドタヌキ", name: "ホンドタヌキ",
    ...
    description: "にほんに しか いない タヌキ。イヌの なかまだけど、ふゆに なると ねむりに ちかい じょうたいで すごす ふしぎな くせを もつ。むかしばなしでも おおにんき！" , lifespanYears: 7},

  // ── きつね ──
  { animalId: "fox_red", genericName: "きつね", specificName: "キタキツネ", name: "キタキツネ",
    emoji: "🦊", rarity: "RARE", stageId: "forest", habitat: "ほっかいどう・サハリンの しんりん",
    description: "ほっかいどうの ゆきの うえで、ゆきの したを はしる ネズミの おとを みみで キャッチ！ジャンプして つかまえる『マウシング』が とくいな かしこい キツネ！" , lifespanYears: 7},
  { animalId: "fox_red_common", genericName: "きつね", specificName: "アカギツネ", name: "アカギツネ",
    ...
    description: "せかいで いちばん ひろく すんでいる キツネ。あかちゃいろの けと ふさふさの しっぽが きれい！とても かしこくて まちに あらわれる ことも あるよ。" , lifespanYears: 7},
  ...
  { animalId: "wolf_gray", genericName: "おおかみ", specificName: "タイリクオオカミ", name: "タイリクオオカミ",
    ...
    description: "イヌの ごせんぞ！5～15ぴきの むれで くらす よ。リーダー ふうふの アルファペアが いて、とおぼえで なかまに あいずを おくる かしこい かぞく！" , lifespanYears: 13},
  { animalId: "wolf_japanese", genericName: "おおかみ", specificName: "ニホンオオカミ", name: "ニホンオオカミ",
    ...
    description: "むかし にほんに すんでいた せかいで いちばん ちいさな オオカミ。やまの かみさまと して まつる ちいきも あった。1905ねん ならけんで さいごの 1ぴきが きろくされた…", isExtinct: true , lifespanYears: 13},

  // ── くま ──
  { animalId: "bear_brown", genericName: "くま", specificName: "ヒグマ", name: "ヒグマ",
    emoji: "🐻", rarity: "RARE", stageId: "forest", habitat: "ほっかいどうの しんりん・かわぞい",
    description: "ほっかいどうに すむ にほん さいだいの りくの どうぶつ！たいじゅう 500キロ オーバーも！あきに サケを たべて、ふゆごもりの まえに たっぷり しぼうを ためる！" , lifespanYears: 25},
  { animalId: "bear_black_asia", genericName: "くま", specificName: "ツキノワグマ", name: "ツキノワグマ",
    ...
    description: "むねに みかづきがたの しろい もようを もつのが なまえの ゆらい。きのぼりが とくいで、ドングリや ハチミツを とりに たかい きにも すいすい のぼる！" , lifespanYears: 25},
  { animalId: "bear_kodiak", genericName: "くま", specificName: "コディアックヒグマ", name: "コディアックヒグマ",
    ...
    description: "ヒグマの あにきぶん！たちあがると みのたけ 3m、たいじゅう 700キロを こえる せかい さいだい きゅうの りく どうぶつ！サケの たべほうだいで そだつ！" , lifespanYears: 25},
  ...
  { animalId: "owl_horned", genericName: "ふくろう", specificName: "ワシミミズク", name: "ワシミミズク",
    ...
    description: "つばさを ひろげると 180cm にも なる せかい さいだい きゅうの フクロウ！はねに ギザギザの ひみつが あって、ほとんど おとを たてずに とぶ よるの おうじゃ！" , lifespanYears: 25},
  { animalId: "owl_eagle_blakiston", genericName: "ふくろう", specificName: "シマフクロウ", name: "シマフクロウ",
    ...
    description: "ほっかいどうに しか いない せかい さいだい きゅうの フクロウ！すいめんに とびこんで サケや マスを つかまえる ハンター！すうが すくなく ぜつめつ きぐしゅ。" , lifespanYears: 20},
  ...
  { animalId: "macaque_japanese", genericName: "さる", specificName: "ニホンザル", name: "ニホンザル",
    ...
    description: "にほんに しか いない サル！じごくだにの『おんせんに はいる サル』で せかいに ゆうめい。100ぴき いじょうの むれを つくり、リーダーは ボスざる！" , lifespanYears: 27},
  { animalId: "chimpanzee", genericName: "さる", specificName: "チンパンジー", name: "チンパンジー",
    ...
    description: "にんげんと いでんしが 98.7％ おなじ！いちばん ちかい しんせき。いしで ナッツを わったり、きの えだを どうぐに して アリを つる！なかまと ハグも するよ。" , lifespanYears: 45},
  { animalId: "gorilla", genericName: "ゴリラ", specificName: "ニシローランドゴリラ", name: "ニシローランドゴリラ",
    ...
    description: "さいだい きゅうの サル！たいじゅう 200キロ こえる ことも。じつは とっても おだやかな くさしょく より。あぶないと むねを ドンドン たたく『ドラミング』を するんだ！" , lifespanYears: 40},
  { animalId: "orangutan", genericName: "さる", specificName: "オランウータン", name: "オランウータン",
    ...
    description: "インドネシアの ジャングルに すむ あかちゃいろの サル！どうぐを つかい、まいばん きの うえに ベッドを つくる。なまえは マレーごで『もりの ひと』という いみ！" , lifespanYears: 45},
  ...
  { animalId: "panda", genericName: "パンダ", specificName: "ジャイアントパンダ", name: "ジャイアントパンダ",
    ...
    description: "ちゅうごくの たけばやしに すむ せかいの アイドル！クマの なかまなのに ごはんは 99％ タケ！1にち 12じかんも たけを たべつづける ふしぎな くま！" , lifespanYears: 20},
  { animalId: "red_panda", genericName: "パンダ", specificName: "レッサーパンダ", name: "レッサーパンダ",
    ...
    description: "じつは ジャイアントパンダより さきに『パンダ』と なづけられた もとせんしゅ！あかちゃいろの もふもふで、たちあがって あいてを いかくする すがたが かわいい！" , lifespanYears: 15},
  { animalId: "tiger_bengal", genericName: "とら", specificName: "ベンガルトラ", name: "ベンガルトラ",
    ...
    description: "せかい さいだいの ネコの なかま！インドに すむ もりの ふくびきおうしゃ。しまもようは 1ぴき ずつ ちがって ゆびもんの よう。およぎが とくいで ワニまで！" , lifespanYears: 16},
  { animalId: "tiger_white", genericName: "とら", specificName: "ホワイトタイガー", name: "ホワイトタイガー",
    ...
    description: "とつぜん へんいで うまれた しろい ベンガルトラ！あおい め と しろい けに くろい しま という ファンタジー みたいな すがた。やせいでは とても めずらしい！" , lifespanYears: 16},
  { animalId: "beaver", genericName: "ビーバー", specificName: "アメリカビーバー", name: "アメリカビーバー",
    ...
    description: "するどい はで きを きりたおして、かわに ダムを つくる けんちくか！ながさ 1キロの ダムを つくる ことも。きたアメリカの しんりんを かえる すごい パワー！" , lifespanYears: 24},
  { animalId: "koala", genericName: "コアラ", specificName: "コアラ", name: "コアラ",
    emoji: "🐨", rarity: "RARE", stageId: "forest", habitat: "オーストラリアの ユーカリばやし",
    description: "オーストラリアの ユーカリの きの うえで、1にち 20じかんも ねている のんびり やさん！あかちゃんは『ジョーイ』と よばれ、おかあさんの ふくろの なかで そだつ！" , lifespanYears: 13},
  ...
  { animalId: "zebra_plains", genericName: "しまうま", specificName: "サバンナシマウマ", name: "サバンナシマウマ",
    ...
    description: "くろと しろの しま もようは 1ぴき ずつ ちがう！むれに なると しまが まじって、ライオンに ねらいを つけさせない さくせん。1にちで 20キロも あるくよ！" , lifespanYears: 25},
  { animalId: "zebra_grevy", genericName: "しまうま", specificName: "グレビーシマウマ", name: "グレビーシマウマ",
    ...
    description: "せかいで いちばん おおきな シマウマ！しまの はばが ほそくて、おなかが しろい。みみが まんまる おおきくて、すぐ みわけられるよ！すうが すくなく きちょう。" , lifespanYears: 20},
  { animalId: "wildebeest", genericName: "ヌー", specificName: "オグロヌー", name: "オグロヌー",
    ...
    description: "まいとし 150まんとうが あめを おって おおいどう！マラがわを わたる えいぞうは サバンナの きびしさを みせる。うまれた こうしは すうふんで たちあがる！" , lifespanYears: 20},
  { animalId: "meerkat", genericName: "ミーアキャット", specificName: "ミーアキャット", name: "ミーアキャット",
    ...
    description: "むれで じめんに あなを ほって くらすよ。みはりやくが まっすぐ たちあがり、そらの ワシ・じめんの ヘビなど あいてに よって なきごえを かえる かしこい コミュニティ！" , lifespanYears: 14},
  { animalId: "warthog", genericName: "イノシシ", specificName: "イボイノシシ", name: "イボイノシシ",
    emoji: "🐗", rarity: "COMMON", stageId: "savanna", habitat: "サハラいなんの くさち",
    description: "かおの ひだりみぎに ある イボが なまえの ゆらい。ライオンから にげる ときは じそく 55キロ！ふだんは ほかの どうぶつが ほった あなを リフォームして ねる！" , lifespanYears: 15},
  { animalId: "ostrich", genericName: "ダチョウ", specificName: "ダチョウ", name: "ダチョウ",
    emoji: "🦤", rarity: "COMMON", stageId: "savanna", habitat: "アフリカの かわいた くさち",
    description: "せかい さいだいの とり！みのたけ 2.7m。そらは とべないけど じそく 70キロで はしる！つよい あしの けりは ライオンの ずがいこつを くだく いりょく！" , lifespanYears: 45},
  { animalId: "giraffe", genericName: "キリン", specificName: "アミメキリン", name: "アミメキリン",
    emoji: "🦒", rarity: "RARE", stageId: "savanna", habitat: "ひがしアフリカの サバンナ",
    description: "くびだけで 2m こえる！した は 50cm にも なる！しんぞうは とくべつ おおきくて、くびの うえまで けつえきを おくる。あかしあの トゲも したで まきとって たべる！" , lifespanYears: 25},
  { animalId: "giraffe_masai", genericName: "キリン", specificName: "マサイキリン", name: "マサイキリン",
    ...
    description: "キリンの なかまで さいだい！もようは ぎざぎざの くっきりした かたち。からだの たかさ 5.5m！すいみんは 1にち たった 20ぷんと、せかい さいたん きゅう！" , lifespanYears: 25},
  { animalId: "hyena_spotted", genericName: "ハイエナ", specificName: "ブチハイエナ", name: "ブチハイエナ",
    ...
    description: "ほねを かみくだく アゴの ちから は サバンナ いちばん！えものの 70％は じぶんで かりする ハンター！むれの リーダーは メスで、しゃかいせいが たかい！" , lifespanYears: 25},
  { animalId: "hyena_striped", genericName: "ハイエナ", specificName: "シマハイエナ", name: "シマハイエナ",
    ...
    description: "ハイエナ かぞくで いちばん ちいさい しゅ。しまもようで くび から せなかに たてがみが ある！ほねを たべる めいじん。やしょこうせいで しゃかいせいも たかい。" , lifespanYears: 12},
  { animalId: "leopard", genericName: "ヒョウ", specificName: "ヒョウ", name: "ヒョウ",
    emoji: "🐆", rarity: "RARE", stageId: "savanna", habitat: "アフリカ・アジアの しんりん・くさち",
    description: "じぶんの 3ばいの たいじゅうの シカでも きの うえに はこべる かいりき！よるの ステルス ハンターで、ひとの けはいを かんじると おとも なく きえる！" , lifespanYears: 17},
  { animalId: "rhino_black", genericName: "サイ", specificName: "クロサイ", name: "クロサイ",
    ...
    description: "アフリカに のこる サイの しゅるい。つのは ツメと おなじ せいぶんの ケラチン！みつりょうで かずが へっていて、やせいでは いま 5000とう を きった…" , lifespanYears: 40},
  { animalId: "rhino_white", genericName: "サイ", specificName: "シロサイ", name: "シロサイ",
    emoji: "🦏", rarity: "RARE", stageId: "savanna", habitat: "みなみアフリカの くさち",
    description: "ゾウの つぎに おおきい りく どうぶつで たいじゅう 2.3t こえ！きたぶ あしゅは 2018ねんに さいごの オスが しに、いまは じんこうじゅせいで まもられている！" , lifespanYears: 50},
  { animalId: "lion", genericName: "ライオン", specificName: "アフリカライオン", name: "アフリカライオン",
    ...
    description: "ひゃくじゅうの おう！むれ（プライド）で くらす ゆいいつの ネコの なかま。かりは メスが たんとう！オスの たてがみは としで くろくなるほど つよさの あかし！" , lifespanYears: 15},
  { animalId: "lion_white", genericName: "ライオン", specificName: "ホワイトライオン", name: "ホワイトライオン",
    ...
    description: "みなみアフリカの とくべつな ちいきに うまれる、とつぜん へんいで しろい ライオン！しき そが うすくなる『リューシズム』に よる もの。やせいでは ほとんど みられない！" , lifespanYears: 15},
  { animalId: "elephant_african", genericName: "ぞう", specificName: "アフリカゾウ", name: "アフリカゾウ",
    ...
    description: "りく さいだいの どうぶつで たいじゅう 6t！はなの きんにくは 15まんぼん も！とても かしこく、しんだ なかまの ほねを なでる『とむらい』の こうどうも かくにん されている！" , lifespanYears: 60},
  { animalId: "elephant_asian", genericName: "ぞう", specificName: "アジアゾウ", name: "アジアゾウ",
    ...
    description: "アフリカゾウより こがたで みみが ちいさい。むかしから にんげんと いっしょに はたらいた れきしを もち、ぶっきょうでは しんせいな どうぶつ！かがみで じぶんを みとめられる かしこさ！" , lifespanYears: 60},
  { animalId: "cheetah", genericName: "チーター", specificName: "チーター", name: "チーター",
    emoji: "🐆", rarity: "EPIC", stageId: "savanna", habitat: "アフリカの サバンナ",
    description: "りく さいそく！じそく 110キロを こえる しゅんぱつりょく！ただし ちょうきょりは はしれず 30びょうで ちからつきる。ツメが ひっこまず、ろめんを ける ちからが つよい！" , lifespanYears: 12},
  { animalId: "buffalo_cape", genericName: "バッファロー", specificName: "ケープバッファロー", name: "ケープバッファロー",
    ...
    description: "『くろい しにがみ』の いみょうを もつ アフリカ ごだいじゅうの ひとつ！むれで けっそくし、ライオンより ひとを ししに いたらしめる！つのの はばは 1m！" , lifespanYears: 22},
  { animalId: "fennec_fox", genericName: "きつね", specificName: "フェネック", name: "フェネック",
    emoji: "🦊", rarity: "RARE", stageId: "savanna", habitat: "サハラさばく・きたアフリカ",
    description: "せかい さいしょうの キツネ！サハラさばくに すみ、からだの わりに きょだいな みみで さばくの ねつを ほうさんして からだを ひやす！よるに あなを ほって くらすよ！" , lifespanYears: 12},
  { animalId: "baboon", genericName: "さる", specificName: "マントヒヒ", name: "マントヒヒ",
    emoji: "🐒", rarity: "RARE", stageId: "savanna", habitat: "アフリカの くさち・がんざんちたい",
    description: "オスの くびの まわりに ぎんいろの たてがみが ある サル！むかし エジプトでは『かみの つかい』として たいせつに された！むれで けんりょくを きょうそうする ふくざつな しゃかい！" , lifespanYears: 30},
  { animalId: "hippopotamus", genericName: "カバ", specificName: "カバ", name: "カバ",
    emoji: "🦛", rarity: "EPIC", stageId: "savanna", habitat: "サハラいなんの かわ・みずうみ",
    description: "アフリカで いちばん にんげんを おそう どうぶつ！ふだんは みずに もぐっていて、よるに くさを たべに あがる。じそく 30キロで はしるよ！はだから あかい『ひざわ』が でる！" , lifespanYears: 45},
  { animalId: "crocodile_nile", genericName: "ワニ", specificName: "ナイルワニ", name: "ナイルワニ",
    ...
    description: "アフリカ さいだいの ワニ！たいちょう 5m こえる ことも。ヌーの たいぐんが かわを わたる ときに まちぶせる おそろしい ハンター！くちは とじる ちからは あくいだが、ひらく ちからは よわい！" , lifespanYears: 70},
  { animalId: "flamingo", genericName: "とり", specificName: "オオフラミンゴ", name: "オオフラミンゴ",
    ...
    description: "あかい モ や プランクトンを たべる ことで からだが ピンクに なる！ふしぎ。1ぽんあしで ねむる くせが あって、こうごに あしを やすめる！" , lifespanYears: 40},
  ...
  { animalId: "reindeer", genericName: "しか", specificName: "トナカイ", name: "トナカイ",
    ...
    description: "シカの なかまで ゆいいつ、オスも メスも ツノを もつ ふしぎな しゅ！きびしい さむさに たいおうし、ひづめは ゆきを しっかり ふみしめる かたち！おおぜいで ながい たびを する！" , lifespanYears: 15},
  { animalId: "musk_ox", genericName: "うし", specificName: "ジャコウウシ", name: "ジャコウウシ",
    ...
    description: "ひょうがきから いきのこった すうすくない ほにゅうるい！ながい けと あつい たいもうで -40度にも たえる！おそわれると えんじんを くんで こどもを まもる！" , lifespanYears: 20},
  { animalId: "arctic_fox", genericName: "きつね", specificName: "ホッキョクギツネ", name: "ホッキョクギツネ",
    ...
    description: "なつは ちゃいろ、ふゆは まっしろに けが かわる！みみと はなが ちいさく さむさで こおるのを ふせぐ。-50度でも へいきな ほにゅうるい さいきょうの たいかんのうりょく！" , lifespanYears: 3},
  { animalId: "polar_bear", genericName: "くま", specificName: "ホッキョクグマ", name: "ホッキョクグマ",
    ...
    description: "せかい さいだいの にくしょく りく どうぶつ！しろく みえる けは じつは とうめいで、ひかりを はんしゃして しろく みえる！およぎも とくいで じそく 10キロで およぐ！" , lifespanYears: 25},
  { animalId: "snow_leopard", genericName: "ヒョウ", specificName: "ユキヒョウ", name: "ユキヒョウ",
    ...
    description: "ひょうこう 3000～6000m の いわやまに すむ きちょうな ネコの なかま。すいちょく 50m の がけを かけおりる！じぶんの たいちょうの 6ばいを いっとびで とぶ！" , lifespanYears: 15},
  { animalId: "owl_snowy", genericName: "ふくろう", specificName: "シロフクロウ", name: "シロフクロウ",
    ...
    description: "ほっきょくけんに すむ まっしろな フクロウ。ゆきの うえで かんぺきな カモフラージュ！ほかの フクロウと ちがい ひるも かつどうする。ハリー・ポッターの ヘドウィグの モデル！" , lifespanYears: 10},
  { animalId: "walrus", genericName: "セイウチ", specificName: "セイウチ", name: "セイウチ",
    ...
    description: "1m こえる キバは オス メス りょうほうが もつ！こおりに あなを あけて こきゅうしたり、ひょうかを のぼる つえに する！たいじゅう 1.5t！うみぞこの ハマグリを すいこむ！" , lifespanYears: 40},
  { animalId: "saiga", genericName: "アンテロープ", specificName: "サイガアンテロープ", name: "サイガアンテロープ",
    ...
    description: "ひょうがきから いきつづける『いきた かせき』。とくちょうてきな たれた はなは、ふゆは つめたい くうきを あたためる！2015ねんに なぞの ばいきんで おおぜい しんで ぜつめつ きぐ！" , lifespanYears: 10},
  { animalId: "penguin_emperor", genericName: "ペンギン", specificName: "コウテイペンギン", name: "コウテイペンギン",
    ...
    description: "なんきょくの ひょうげんに すむ せかい さいだいの ペンギン！たかさ 1.2m！オスは -60度の さむさで 2かげつ なにも たべずに たまごを あたためつづける ちちおや の かがみ！" , lifespanYears: 20},
  { animalId: "orca", genericName: "クジラ", specificName: "シャチ", name: "シャチ",
    emoji: "🐳", rarity: "EPIC", stageId: "ice_age", habitat: "せかいの つめたい うみ",
    description: "うみの ハンターの たいちょう！むれで こうどうする かしこい イルカの なかま。シロナガスクジラさえ おそう ことが ある！くろと しろの もようは みると かっこいい！" , lifespanYears: 60},
  { animalId: "narwhal_ice", genericName: "クジラ", specificName: "イッカク", name: "イッカク",
    emoji: "🐳", rarity: "EPIC", stageId: "ice_age", habitat: "ほっきょくかい",
    description: "ほっきょくの うみに すむ、つの の はえた『うみの ユニコーン』！じつは つので なく、ねじれた『きば』！ながさ 3m にも なって、おもに オスが もつ ふしぎな クジラ！" , lifespanYears: 50},
  { animalId: "elephant_mammoth", genericName: "ぞう", specificName: "ケナガマンモス", name: "ケナガマンモス",
    ...
    description: "やく 4000ねん まえまで いきていた ゾウの なかま！ながい まがった キバと あつい けがわが ひょうがきの さむさに ぴったり！シベリアの こおりの したから みつかる！", isExtinct: true , lifespanYears: 60},
  { animalId: "mammoth_columbian", genericName: "ぞう", specificName: "コロンビアマンモス", name: "コロンビアマンモス",
    ...
    description: "きたアメリカに すんでいた きょだいな マンモス！ケナガマンモスより おおきく、たかさ 4m こえる！キバは わんきょくして 4m にも たっした きょじん！", isExtinct: true , lifespanYears: 60},
  { animalId: "sabertooth", genericName: "ねこ", specificName: "スミロドン", name: "スミロドン（サーベルタイガー）",
    ...
    description: "うわあごから 28cm の つるぎ みたいな きば！しじょう さいきょう きゅうの にくしょくじゅう！えものの のどを きばで さきさく かりを していた。1まんねん まえに ぜつめつ…", isExtinct: true , lifespanYears: 28},
  { animalId: "woolly_rhino", genericName: "サイ", specificName: "ケナガサイ", name: "ケナガサイ",
    ...
    description: "ぜんしんを あつい けで おおわれた ひょうがきの サイ！ふたつの つのの まえの つのは ながさ 1m！ゆきを かきわけて くさを たべた きょじん！", isExtinct: true , lifespanYears: 45},
  { animalId: "megaloceros", genericName: "しか", specificName: "オオツノジカ", name: "オオツノジカ",
    ...
    description: "ツノの はばが 3.6m に たっした しじょう さいだい きゅうの シカ！やく 7700ねん まえまで いきていた。アイルランドの どろの したから ぜんしんの ほねが でた！", isExtinct: true , lifespanYears: 20},
  { animalId: "dire_wolf", genericName: "おおかみ", specificName: "ダイアウルフ", name: "ダイアウルフ",
    emoji: "🐺", rarity: "EPIC", stageId: "ice_age", habitat: "むかしの きたアメリカ",
    description: "いまの ハイイロオオカミより ひとまわり おおきく、かむ ちからは 1.5ばい！やく 1まんねん まえに ぜつめつした ひょうがきの ちょうてん ハンター！", isExtinct: true , lifespanYears: 10},
  { animalId: "glyptodon", genericName: "アルマジロ", specificName: "グリプトドン", name: "グリプトドン",
    emoji: "🐢", rarity: "EPIC", stageId: "ice_age", habitat: "むかしの みなみ・きたアメリカ",
    description: "ぜんちょう 3m・たいじゅう 2t の きょだいな アルマジロ！せなかは 1000まい いじょうの ほねで おおわれた こうら！しっぽの さきに てきを なぐる ホネの こんぼう！", isExtinct: true , lifespanYears: 30},
  { animalId: "cave_bear", genericName: "くま", specificName: "ホラアナグマ", name: "ホラアナグマ",
    ...
    description: "ひょうがきの ヨーロッパに すんでいた おおきな クマ！どうくつに すみ、ネアンデルタールじんと ばしょを とりあって たたかった ことも！ぜつめつしてしまった…", isExtinct: true , lifespanYears: 20},
  { animalId: "ground_sloth", genericName: "ナマケモノ", specificName: "メガテリウム", name: "メガテリウム",
    ...
    description: "じめんに すんでいた きょだいな ナマケモノ！たかさ 6m・たいじゅう 4t！うしろあしで たって きの たかい はを たべた。じょうもん じだいまで いきていた かも！", isExtinct: true , lifespanYears: 40},
  { animalId: "paraceratherium", genericName: "サイ", specificName: "パラケラテリウム", name: "パラケラテリウム",
    ...
    description: "ぜつめつしてしまった、しじょう さいだい きゅうの りく ほにゅうるい！くびを いれて たかさ 8m！ゾウと キリンを たして 2 で わったような すがた！", isExtinct: true , lifespanYears: 30},
  { animalId: "smilodon_populator", genericName: "ねこ", specificName: "スミロドン・ポプラトル", name: "スミロドン・ポプラトル",
    ...
    description: "サーベルタイガーの ちょうだい けっさく！たいじゅう 400キロ こえ、いまの トラの 1.5ばい！28cm の きばで グランドスロスや コロンビアマンモスを かりした！", isExtinct: true , lifespanYears: 28},
  ...
  { animalId: "clownfish", genericName: "さかな", specificName: "カクレクマノミ", name: "カクレクマノミ",
    ...
    description: "イソギンチャクの どくに たえる パートナー！からだの ねんえきで どくを なかわした！うまれた ときは みんな オスで、ぐんの さいだい こたいが メスに かわる！" , lifespanYears: 10},
  { animalId: "octopus_common", genericName: "たこ", specificName: "マダコ", name: "マダコ",
    emoji: "🐙", rarity: "COMMON", stageId: "deep_sea", habitat: "せかいじゅうの うみ",
    description: "のうが 9つも ある！はだで いろや ひかりを かんじる ふしぎ。びんの フタを あける パズルも すうふんで とく！じゅみょうは 1～2ねんと みじかい てんさい！" , lifespanYears: 1},
  { animalId: "jellyfish_moon", genericName: "くらげ", specificName: "ミズクラゲ", name: "ミズクラゲ",
    ...
    description: "からだの 95％が みず！のうも しんぞうも ほねも ない！それでも 5おくねん いきのこってきた ちきゅう さいこの どうぶつ なかま！" , lifespanYears: 1},
  ...
  { animalId: "manta_ray", genericName: "エイ", specificName: "オニイトマキエイ（マンタ）", name: "オニイトマキエイ",
    ...
    description: "ヒレの はしから はしまで 7m に たっする きょだいな エイ！にんげん なみに かしこくて、かがみで じぶんを みとめられる！プランクトンを こして たべる おだやかな きょじん！" , lifespanYears: 40},
  { animalId: "great_white_shark", genericName: "サメ", specificName: "ホホジロザメ", name: "ホホジロザメ",
    ...
    description: "たいちょう 6m こえる うみの ちょうてん ハンター！はなさきに でんきを かんじる ロレンチーニ きかんが あり、えものの しんぞうおとまで キャッチ！いっしょうで 2まんぼんの はが はえかわる！" , lifespanYears: 70},
  { animalId: "whale_shark", genericName: "サメ", specificName: "ジンベエザメ", name: "ジンベエザメ",
    ...
    description: "せかい さいだいの さかな！たいちょう 13m、たいじゅう 20t！おおきな くちで みずを すいこみ、プランクトンや ちいさな さかなを たべる おだやかな きょじん！" , lifespanYears: 130},
  { animalId: "moray_eel", genericName: "うつぼ", specificName: "ウツボ", name: "ウツボ",
    emoji: "🐟", rarity: "RARE", stageId: "deep_sea", habitat: "せかいの あさい さんごしょう",
    description: "なんと あごが ふたつ ある！くちの おくに『のどの あご』が かくれていて、えものを くわえると ぐいっと のどに ひきこむ！うみの エイリアンの ような さかな！" , lifespanYears: 30},
  { animalId: "mantis_shrimp", genericName: "エビ", specificName: "シャコ（モンハナシャコ）", name: "モンハナシャコ",
    ...
    description: "パンチの はやさが だんがんと おなじ！じそく 80キロ！みず の なかで そくど が はやすぎて あわが かんしゃくの ように はじけて あいてを やっつける！" , lifespanYears: 6},
  { animalId: "anglerfish", genericName: "アンコウ", specificName: "チョウチンアンコウ", name: "チョウチンアンコウ",
    ...
    description: "あたまから ぴかぴか ひかる『ちょうちん』で えものを よびよせる しんかいの ハンター！オスは メスの 100ぶんの 1の おおきさで、メスに かみついて ゆごう する ふしぎ！" , lifespanYears: 20},
  { animalId: "lanternfish", genericName: "さかな", specificName: "ハダカイワシ", name: "ハダカイワシ",
    ...
    description: "しんかいで いちばん かずが おおい さかな！からだに ひかる つぶつぶが ならんでいて、よる に なると いっせいに ひかる！うみの イルミネーション！" , lifespanYears: 1},
  { animalId: "vampire_squid", genericName: "イカ", specificName: "コウモリダコ", name: "コウモリダコ",
    ...
    description: "『じごくの きゅうけつイカ』と よばれる けれど、イカ でも タコ でもない べつ けいとうの あたまあし るい！からだは あおぐろく、めは あかい いきた かせき！" , lifespanYears: 8},
  { animalId: "dumbo_octopus", genericName: "たこ", specificName: "メンダコ", name: "メンダコ",
    ...
    description: "あたまから ピョコンと はえた ふたつの ヒレで、ディズニーキャラの ダンボみたいに ひらひら およぐ かわいい しんかい タコ！おおきな めが チャームポイント！" , lifespanYears: 3},
  { animalId: "oarfish", genericName: "さかな", specificName: "リュウグウノツカイ", name: "リュウグウノツカイ",
    ...
    description: "たいちょう 11m に たっする せかい さいちょうの ほねの さかな！あかい とさかと ぎんいろの ほそながい からだから『にんぎょ』『りゅうぐうの つかい』の でんせつの もとに！" , lifespanYears: 10},
  { animalId: "giant_squid", genericName: "イカ", specificName: "ダイオウイカ", name: "ダイオウイカ",
    ...
    description: "ぜんちょう 13m・めは バスケットボール おおきさ の せかい さいだいの イカ！マッコウクジラと たたかう でんせつの そんざい！2012ねんに おがさわら おきで さつえいに せかい はじめて せいこう！" , lifespanYears: 5},
  { animalId: "blue_whale", genericName: "クジラ", specificName: "シロナガスクジラ", name: "シロナガスクジラ",
    ...
    description: "たいちょう 30m・たいじゅう 200t！しじょう さいだいの どうぶつ！きょうりゅうより おおきい！しんぞうは けいじどうしゃ サイズ、なきごえは 1600キロ さきまで とどく！" , lifespanYears: 80},
  { animalId: "humpback_whale", genericName: "クジラ", specificName: "ザトウクジラ", name: "ザトウクジラ",
    ...
    description: "ながい ヒレと きょくに とんだ うたごえで ゆうめい！おすの こいの うたは 30ぷん つづく ことも！うみから おおきく ジャンプする すがたは いやしの あいてとう！" , lifespanYears: 80},
  { animalId: "dolphin_bottlenose", genericName: "イルカ", specificName: "ハンドウイルカ", name: "ハンドウイルカ",
    emoji: "🐬", rarity: "RARE", stageId: "deep_sea", habitat: "せかいの あたたかい うみ",
    description: "すいぞくかんで おなじみの ともだち！じこ にんしき（じぶんの すがたを かがみで わかる）が できる かしこい うみの にんしゃ！すいみんは のうの はんぶんずつ！" , lifespanYears: 50},
  { animalId: "sea_turtle", genericName: "カメ", specificName: "アオウミガメ", name: "アオウミガメ",
    emoji: "🐢", rarity: "RARE", stageId: "deep_sea", habitat: "せかいの ねったい・あねったい うみ",
    description: "うまれた はまべに もどって たまごを うむ ナビゲーション めいじん！1ぴき あたり 100ねん ちかく いきる ことも！うみの りゅうかいを なんびゃくキロも およぐ！" , lifespanYears: 80},
  { animalId: "coelacanth", genericName: "さかな", specificName: "シーラカンス", name: "シーラカンス",
    ...
    description: "4おくねん まえから すがたを ほとんど かえずに いきつづける『いきた かせき』！1938ねんに みなみアフリカで さいはっけんされるまで ぜつめつしたと おもわれていた！" , lifespanYears: 60},
  { animalId: "narwhal", genericName: "クジラ", specificName: "イッカク（うみの ユニコーン）", name: "イッカク",
    emoji: "🐳", rarity: "EPIC", stageId: "deep_sea", habitat: "ほっきょくかい",
    description: "ほっきょくの うみに すむ つの の はえた クジラ！じつは つので なく、ねじれた『きば』！ながさ 3m！『うみの ユニコーン』と よばれる ふしぎな いきもの！" , lifespanYears: 50},
  { animalId: "megalodon", genericName: "サメ", specificName: "メガロドン", name: "メガロドン",
    ...
    description: "やく 300まんねん まえまで いきていた しじょう さいだいの サメ！たいちょう 18m・はの おおきさ 18cm！いまの ホホジロザメの 3ばい いじょう！クジラさえ たべた！", isExtinct: true , lifespanYears: 25},
  ...
  { animalId: "compsognathus", genericName: "きょうりゅう", specificName: "コンプソグナトゥス", name: "コンプソグナトゥス",
    ...
    description: "ぜんちょう 1m・たいじゅう 3kg の ちいさな にくしょく きょうりゅう！にわとりほどの サイズで、トカゲや むしを たべた！おなかから トカゲが まるごと みつかった！", isExtinct: true , lifespanYears: 15},
  { animalId: "iguanodon", genericName: "きょうりゅう", specificName: "イグアノドン", name: "イグアノドン",
    ...
    description: "1822ねんに せかいで 2ばんめに なづけられた きょうりゅう！おやゆびに おおきな トゲを もって、ぼうぎょや ごはんに つかった！はじめは はなの うえの つのと まちがえられた！", isExtinct: true , lifespanYears: 20},
  { animalId: "archaeopteryx", genericName: "とり", specificName: "シソチョウ", name: "シソチョウ",
    ...
    description: "きょうりゅうと とりの あいだ！うろこと はねの りょうほうを もつ ふしぎな いきもの。ながさ 50cm。とぶ ことが できたかは いまも なぞ！とりの ごせんぞ かもしれない！", isExtinct: true , lifespanYears: 10},
  { animalId: "velociraptor", genericName: "きょうりゅう", specificName: "ヴェロキラプトル", name: "ヴェロキラプトル",
    ...
    description: "じっさいは シチメンチョウほどの サイズで ぜんしんに はねが あった ちいさな じゅうきゃくるい！うしろあしの かまづめで えものに とびかかった！えいがでは おおきく えがかれた！", isExtinct: true , lifespanYears: 15},
  { animalId: "parasaurolophus", genericName: "きょうりゅう", specificName: "パラサウロロフス", name: "パラサウロロフス",
    ...
    description: "あたまから うしろに ながく のびた『つの の トランペット』が トレードマーク！なかが つうろに なっていて、ふいて おおきな おとを だして なかまを よんだと いわれている！", isExtinct: true , lifespanYears: 25},
  { animalId: "stegosaurus", genericName: "きょうりゅう", specificName: "ステゴサウルス", name: "ステゴサウルス",
    ...
    description: "せなかの 17まいの こつばん は たいおん ちょうせつと ぼうぎょの きのうを かねた！のうの おおきさは クルミの サイズ！しっぽの 4ぼんの トゲで みを まもった！", isExtinct: true , lifespanYears: 25},
  { animalId: "ankylosaurus", genericName: "きょうりゅう", specificName: "アンキロサウルス", name: "アンキロサウルス",
    emoji: "🦕", rarity: "RARE", stageId: "cretaceous", habitat: "はくあき こうきの きたアメリカ",
    description: "ぜんしんを ほねの よろいと トゲで かためた せんしゃの ような きょうりゅう！しっぽの さきに 20kg の こんぼうで、ティラノサウルスの あしを ほねおりさせる いりょく！", isExtinct: true , lifespanYears: 25},
  { animalId: "pteranodon", genericName: "翼竜", specificName: "プテラノドン", name: "プテラノドン",
    emoji: "🦅", rarity: "RARE", stageId: "cretaceous", habitat: "はくあき こうきの きたアメリカ",
    description: "つばさを ひろげると 7m の きょだいな よくりゅう！はが なく、うしろに そった おおきな トサカが とくちょう！うみの うえを とんで さかなを すくいあげた！", isExtinct: true , lifespanYears: 12},
  { animalId: "spinosaurus", genericName: "きょうりゅう", specificName: "スピノサウルス", name: "スピノサウルス",
    ...
    description: "ティラノサウルスより おおきい ぜんちょう 15m の しじょう さいだい きゅうの にくしょくじゅうきゃくるい！せなかに 2m の ほが あり、ワニみたいに みず の なかで くらした！", isExtinct: true , lifespanYears: 30},
  { animalId: "allosaurus", genericName: "きょうりゅう", specificName: "アロサウルス", name: "アロサウルス",
    ...
    description: "ジュラき の さいきょう プレデター！ぜんちょう 12m。ティラノサウルスより 8000まんねん まえに いきていた じゅうきゃくるいの おう！むれで かりした かもしれない！", isExtinct: true , lifespanYears: 25},
  { animalId: "carnotaurus", genericName: "きょうりゅう", specificName: "カルノタウルス", name: "カルノタウルス",
    ...
    description: "あたまに 2ぽんの ツノが はえた めずらしい にくしょく きょうりゅう！ぜんちょう 8m。じそく 50キロで はしる はやい ハンターだったかも！」（みじかい てが チャームポイント！", isExtinct: true , lifespanYears: 20},
  { animalId: "diplodocus", genericName: "きょうりゅう", specificName: "ディプロドクス", name: "ディプロドクス",
    emoji: "🦕", rarity: "EPIC", stageId: "cretaceous", habitat: "ジュラき こうきの きたアメリカ",
    description: "ぜんちょう 33m！くびと しっぽが すっごく ながい くさしょく きょうりゅう！しっぽを むちみたいに ふって おとが おんそく を こえる ことも あった！", isExtinct: true , lifespanYears: 80},
  { animalId: "ichthyosaurus", genericName: "海棲爬虫類", specificName: "イクチオサウルス", name: "イクチオサウルス",
    ...
    description: "イルカそっくりの すがたを した うみの は虫るい！ぜんちょう 2m。きょうりゅうじだいに うみで くらした、たまごでなく こを うむ めずらしい は虫るい！", isExtinct: true , lifespanYears: 25},
  { animalId: "plesiosaurus", genericName: "海棲爬虫類", specificName: "プレシオサウルス", name: "プレシオサウルス",
    emoji: "🐢", rarity: "EPIC", stageId: "cretaceous", habitat: "ジュラき～はくあきの うみ",
    description: "ながい くびと 4まいの ヒレを もつ うみの は虫るい！ぜんちょう 3～5m。スコットランドの ネス湖の かいぶつ ネッシーの モデルとも いわれる！", isExtinct: true , lifespanYears: 30},
  { animalId: "quetzalcoatlus", genericName: "翼竜", specificName: "ケツァルコアトルス", name: "ケツァルコアトルス",
    ...
    description: "せかい さいだいの そらを とぶ いきもの！つばさを ひろげると 11m！キリンの たかさで そらを とぶ、ふしぎな きょだい よくりゅう！", isExtinct: true , lifespanYears: 20},
  { animalId: "trex", genericName: "きょうりゅう", specificName: "ティラノサウルス・レックス", name: "ティラノサウルス・レックス",
    ...
    description: "しじょう さいきょう きゅうの にくしょく きょうりゅう！アゴの かむ ちからは 6トン で てっこうも くだく！たいちょう 13m・たいじゅう 9トン！『T. rex』の かせきは 50たい いじょう みつかった！", isExtinct: true , lifespanYears: 28},
  { animalId: "triceratops", genericName: "きょうりゅう", specificName: "トリケラトプス", name: "トリケラトプス",
    emoji: "🦕", rarity: "LEGENDARY", stageId: "cretaceous", habitat: "はくあき まっきの きたアメリカ",
    description: "3ぼんの ツノと おおきな フリルを もつ くさしょく きょうりゅう！はくあき まっきに ティラノサウルスと おなじ じだいを いきた！フリルは たいおん ちょうせつや なかまの あいず！", isExtinct: true , lifespanYears: 30},
  { animalId: "brachiosaurus", genericName: "きょうりゅう", specificName: "ブラキオサウルス", name: "ブラキオサウルス",
    ...
    description: "ジュラき に いきた ちょうきょだいな くさしょく きょうりゅう！くびが ながく たいちょう 25m・たいじゅう 80トン！まえあしが うしろあしより ながく せなかが まえに かたむいてる！", isExtinct: true , lifespanYears: 100},
  { animalId: "mosasaurus", genericName: "海棲爬虫類", specificName: "モササウルス", name: "モササウルス",
    ...
    description: "はくあき まっきの うみを しはいした ぜんちょう 17m の うみの は虫るい！トカゲから しんかし、いまの オオトカゲや ヘビの とおえん。サメさえ かみくだいた うみの ぜったい おうじゃ！", isExtinct: true , lifespanYears: 30},
...
async function main() {
  ...
  for (const animal of ANIMALS) {
    ...
    const data = {
      ...
      stageId: stageDbId,
      lifespanYears: animal.lifespanYears ?? 10,
    };
